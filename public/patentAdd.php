...
// Description
// -----------
// This method will add a new patent for the business.
//
// Arguments
// ---------
// api_key:
// auth_token:
// business_id:        The ID of the business to add the Patent to.
//
// Returns
// -------
// <rsp stat="ok" id="42">
...
function ciniki_patents_patentAdd(&$ciniki) {
    ...
    $rc = ciniki_patents_checkAccess($ciniki, $args['business_id'], 'ciniki.patents.patentAdd');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    $rc = ciniki_core_objectAdd($ciniki, $args['business_id'], 'ciniki.patents.patent', $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
